...
public class RefreshLayout extends SwipeRefreshLayout implements OnScrollListener {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
            	LogUtils.i("MotionEvent.ACTION_UP  抬起,canload->"+canLoad());
                // 抬起
                if (canLoad()) {
                    loadData();
                }
    ...
    private boolean canLoad() {
    	LogUtils.i("isBottom()->"+isBottom()+"isLoading->"+isLoading+"isPullUp()"+isPullUp());
    ...
    private boolean isBottom() {
        ...
        if (mListView != null && mListView.getAdapter() != null) {
        	LogUtils.i("mListView.getLastVisiblePosition()->"+mListView.getLastVisiblePosition()+"(mListView.getAdapter().getCount() - 1)->"+(mListView.getAdapter().getCount() - 1));
