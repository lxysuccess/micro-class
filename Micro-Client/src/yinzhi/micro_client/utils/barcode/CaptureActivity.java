package yinzhi.micro_client.utils.barcode;

import java.io.IOException;
import java.util.Collection;
import java.util.Hashtable;

import yinzhi.micro_client.activity.AnliActivity;
...
//					 showCustomMessageOK(this.getString(R.string.scanDialogTitle), code) ;
					//转向案例答案页面
					 startActivity(new Intent(this,AnliActivity.class));
					 this.finish();
				}
			}
	...
	private void showCustomMessageOK(String pTitle, final String pMsg) {
		...
		((TextView) lDialog.findViewById(R.id.dialog_message)).setText("this is message"+pMsg);
