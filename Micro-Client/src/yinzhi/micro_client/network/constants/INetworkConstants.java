...
//	public final static String YZMC_SERVER = "http://acc.4i-test.com";
	...
	public final static String API_SCORE_MARK = YZMC_SERVER + "/api/v1/comment/score/marking";
	public final static String API_SCORE_PERSONAL = YZMC_SERVER + "/api/v1/comment/score/personal";
